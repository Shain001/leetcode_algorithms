...
bax = brokenaxes(ylims=((0,1),(115,130)), hspace=0.5, despine=False)
...
bax.legend(loc=2)
bax.set_xlabel('Traffic Signal Percentage (%)', labelpad= 20)
bax.set_ylabel('Travel Distance (KM)', labelpad=40)
plt.show()

bax = brokenaxes(ylims=((0,1),(9500,11000)), hspace=0.5, despine=False)
bax.plot(x_axis, vt_t, marker='o',markersize=10, label = 'VT Model')
bax.plot(x_axis, avg_t, marker='v',markersize=10, label = 'Mesoscopic Model')
bax.plot(x_axis, d_t, marker='s',markersize=10, label = 'Dijkstra Model')
bax.plot(x_axis, lt_t, marker='*',markersize=10, label = 'Lowest Time Model')
bax.set_xticks(x_axis)
# bax.set_title('Travel Time Comparison')
bax.legend(loc=2)
bax.set_xlabel('Traffic Signal Percentage (%)', labelpad= 20)
bax.set_ylabel('Travel Time (S)',fontsize=12, labelpad=44)
plt.show()

bax = brokenaxes(ylims=((0,0.01),(7,12)), hspace=0.5, despine=False)
bax.plot(x_axis, vt_fuel, marker='o',markersize=10, label = 'VT Model')
bax.plot(x_axis, avg_fuel, marker='v',markersize=10, label = 'Mesoscopic Model')
bax.plot(x_axis, d_fuel, marker='s',markersize=10, label = 'Dijkstra Model')
bax.plot(x_axis, lt_fuel, marker='*',markersize=10, label = 'Lowest Time Model')
bax.set_xticks(x_axis)
# bax.set_title('Fuel Consumption Comparison')
bax.legend(loc=2)
bax.set_xlabel('Traffic Signal Percentage (%)', labelpad= 20)
bax.set_ylabel('Fuel Consumption (L)',labelpad=35)

# plt.suptitle('Experiment Result - Performance Comparison under Different Traffic Signal Density')
plt.show()
