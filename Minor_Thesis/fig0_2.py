...
# plt.subplot(1,2,1)
plt.plot(x_axis, y1, marker='o', markersize=10, label="VT-CPFM Model")
plt.plot(x_axis, y2, marker='s', markersize=10,label="Mesoscopic Model")

plt.xticks(x_axis, fontsize=15)
plt.yticks(fontsize=15)
plt.xlabel("Travel Distance (KM)", fontsize=15)
plt.ylabel("Fuel Consumption (L)", fontsize=15)
plt.ylim(ymin=0)
plt.legend()
...
# plt.subplot(1,2,2)
plt.plot(x_axis, y3, marker='o', markersize=10,label="VT-CPFM Model")
plt.plot(x_axis, y4, marker='s', markersize=10,label="Mesoscopic Model")
